...
module.exports = "<iframe style=\"width:100%;border: None;height:100%;\" src=\"https://www.salvaloc.fr/\"></iframe>\n"
...
var NewUserComponent = /** @class */ (function () {
    ...
    NewUserComponent.prototype.sendUser = function () {
        ...
        this.api.add(this.email, this.firstname, this.lastname, this.modele).subscribe(function (r) {
            ...
            _this.message = "Votre code d'accès vient d'être envoyé sur votre mail. Vérifier votre boite pour pouvoir vous reconnecter.";
            setTimeout(function () {
                _this.router.navigate(["start"]);
            }, 3000);
        });
